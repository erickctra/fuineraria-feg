...
const siteLinks = ['funeral', 'translado', 'assistencia', 'empresas', 'cremacao', 'tanatopraxia']

if (siteLinks.includes(param[1])) {
    showModal(param[1]);
}
...
// const myDialog = document.getElementById('dialog-1');
// const myButton = document.getElementById('dialog-1-button');
